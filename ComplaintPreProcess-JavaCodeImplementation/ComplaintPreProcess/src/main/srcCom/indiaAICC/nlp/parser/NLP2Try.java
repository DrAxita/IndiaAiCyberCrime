...
import main.srcCom.indiaAICC.nlp.analyzer.PorterStemmer;
...
public class NLP2Try {

    private static String paragraph = "Let's pause, \nand then reflect.";

    public static void NP2Main() {
...
//        }
    ...
    private static void usingTheOpenNLPLemmatizer() {
        ...
        try {
            ...
            Logger.getLogger(NLP2Try.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
